...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", default=os.path.join(config_path, "jupiter-configs.json"), metavar="Config", type=str)
    parser.add_argument("-u", "--userdata", default=os.path.join(config_path, "jupiter-user-data"), metavar="User Data", type=str)
